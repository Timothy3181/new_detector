...
public:
  explicit HikCameraNode(const rclcpp::NodeOptions & options) : Node("camera_driver", options)
  {
    ...
    auto camera_info_url =
      this->declare_parameter("camera_info_url", "package://rm_bringup/config/hik_camera_info.yaml");
    ...
    capture_thread_ = std::thread{[this]() -> void {
      ...
      PKA_INFO("rm_hik_camera_node", "Publishing image!");
