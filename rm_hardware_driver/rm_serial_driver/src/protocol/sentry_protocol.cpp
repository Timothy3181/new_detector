...
std::vector<rclcpp::SubscriptionBase::SharedPtr> ProtocolSentry::getSubscriptions(rclcpp::Node::SharedPtr node) 
{
  ...
  auto sub2 = node->create_subscription<rm_interfaces::msg::ChassisCmd>(
    "/cmd_chassis",
    rclcpp::SensorDataQoS(),
